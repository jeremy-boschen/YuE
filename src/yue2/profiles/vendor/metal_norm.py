# Vendored from ComfyUI-AppleSilicon-FP8/_patches/fused_norm_mps.py.
# Copyright (c) 2026 Paweł Mazurkiewicz. SPDX-License-Identifier: MIT
# See APPLESILICON_FP8_LICENSE.txt. No ComfyUI dependencies or global patch installation.
